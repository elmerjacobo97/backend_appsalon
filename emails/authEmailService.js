...
export const sendEmailVerify = async ({ name, email, token }) => {
  ...
  <div style="font-family: 'Arial', sans-serif; color: #333; padding: 20px; text-align: center;">
    ...
    <a href="${process.env.FRONTEND_URL}/auth/verify/${token}" style="text-decoration: none; background-color: #0275d8; color: #fff; padding: 15px 25px; border-radius: 5px; font-weight: bold; margin-top: 20px; display: inline-block; font-size: 18px;">Confirmar Cuenta</a>
